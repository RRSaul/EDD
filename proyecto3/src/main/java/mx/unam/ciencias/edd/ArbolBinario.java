    ...
    protected class Vertice implements VerticeArbolBinario<T> {
        ...
        @Override public boolean equals(Object objeto) {
            ...
            if(elemento.equals(vertice.elemento)){
                return equalsDer(this,vertice) && equalsIz(this,vertice);
            }
            return false;
        }

        public boolean equalsIz(Vertice v1, Vertice v2){
            if (v1.hayIzquierdo() && v2.hayIzquierdo())
                return v1.izquierdo.equals(v2.izquierdo);
            return !v1.hayIzquierdo() && !v2.hayIzquierdo();


        }

        public boolean equalsDer(Vertice v1, Vertice v2){
            if (v1.hayDerecho() && v2.hayDerecho())
                return v1.derecho.equals(v2.derecho);
            return !v1.hayDerecho() && !v2.hayDerecho();
        }
